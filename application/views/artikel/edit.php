					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<?php foreach($ubah as $key => $value){?>
								<form class="form-horizontal" method="post" action="<?php echo site_url('artikel/ubahdata/'.$value['idartikel'])?>" enctype="multipart/form-data">
									<fieldset class="content-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<textarea rows="30" cols="5" class="form-control" name="isiartikel"><?php echo $value['isiartikel'];?></textarea>
											</div>
										</div>
