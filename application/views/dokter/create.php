				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" method="post" action="<?php echo site_url('dokter/tambahdata')?>" enctype="multipart/form-data">
										...
										<div class="col-lg-10">
											<select name="idkategori" class="form-control" required="">
												<?php foreach($datakategori as $key => $value){?>
				                                	<option value="<?php echo $value['id_kategori_dokter']?>"><?php echo $value['nama_kategori']?></option>
				                                <?php } ?>
				                            </select>
										</div>
									</div>
